/** Minimal inline SVG icons for admin navigation (no extra dependency). */
...
export function IconChartBar({ className = 'h-5 w-5' }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75} aria-hidden>
      ...
      <path strokeLinecap="round" strokeLinejoin="round" d="M7 16v-5m5 5V8m5 8v-3" />
    </svg>
  )
}
...
export function IconPrinter({ className = 'h-5 w-5' }: IconProps) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75} aria-hidden>
