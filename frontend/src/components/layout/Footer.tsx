    ...
    <footer className="w-full font-sans">
      ...
      <div className="bg-[#003eb3] text-white py-6 px-8 flex flex-col md:flex-row justify-between items-center">
        ...
        <div className="flex items-center space-x-4 mb-4 md:mb-0">
          ...
          <a href="https://www.facebook.com/share/1CzqT8s585/?mibextid=wwXIfr" target="_blank" rel="noopener noreferrer" className="hover:text-blue-300">
            {/* Facebook Icon */}
            <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.469h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.469h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
          </a>
          <a href="https://www.instagram.com/elamine.nettoyage?igsh=MWRmNDU5eGt2azIzaA==" target="_blank" rel="noopener noreferrer" className="hover:text-blue-300">
            {/* Instagram Icon */}
          ...
          <a href="https://www.tiktok.com/@elamine.official?_r=1&_t=ZS-97nuP7aQguC" target="_blank" rel="noopener noreferrer" className="hover:text-blue-300">
            {/* TikTok Icon */}
